...
@property (nonatomic, strong) id <DatePickerCellDelegate> _Nullable delegate;
...
@property (nonatomic, strong) DVColorLockView * _Nonnull seperator;
@property (nonatomic, strong) UIView * _Nonnull datePickerContainer;
...
///
/// returns:
/// An initialized DatePickerCell object or nil if the object could not be created.
...
/// returns:
/// The cell’s height.
- (CGFloat)datePickerHeight SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP14DatePickerCell22DatePickerCellDelegate_")
@protocol DatePickerCellDelegate
@optional
- (void)datePickerCell:(DatePickerCell * _Nonnull)cell didPickDate:(NSDate * _Nullable)date;
@end
